...
local Converted = {
	...
	["getgenv()lass"] = Instance.new("UIGradient");
	...
	["getgenv()lass1"] = Instance.new("UIGradient");
	...
	["getgenv()lass2"] = Instance.new("UIGradient");
	...
	["getgenv()lass3"] = Instance.new("UIGradient");
	...
	["getgenv()rabArea"] = Instance.new("TextButton");
...
Converted["getgenv()lass"].Rotation = -22
Converted["getgenv()lass"].Transparency = NumberSequence.new{
	NumberSequenceKeypoint.new(0, 1),
	NumberSequenceKeypoint.new(0.46633419394493103, 0),
	NumberSequenceKeypoint.new(0.9476309418678284, 0.90625),
	NumberSequenceKeypoint.new(1, 1)
}
Converted["getgenv()lass"].Name = "Glass"
Converted["getgenv()lass"].Parent = Converted["_UIStroke"]
...
Converted["getgenv()lass1"].Rotation = -22
Converted["getgenv()lass1"].Transparency = NumberSequence.new{
	NumberSequenceKeypoint.new(0, 1),
	NumberSequenceKeypoint.new(0.46633419394493103, 0),
	NumberSequenceKeypoint.new(0.9476309418678284, 0.90625),
	NumberSequenceKeypoint.new(1, 1)
}
Converted["getgenv()lass1"].Name = "Glass"
Converted["getgenv()lass1"].Parent = Converted["_UIStroke1"]
...
Converted["getgenv()lass2"].Rotation = -22
Converted["getgenv()lass2"].Transparency = NumberSequence.new{
	NumberSequenceKeypoint.new(0, 1),
	NumberSequenceKeypoint.new(0.46633419394493103, 0),
	NumberSequenceKeypoint.new(0.9476309418678284, 0.90625),
	NumberSequenceKeypoint.new(1, 1)
}
Converted["getgenv()lass2"].Name = "Glass"
Converted["getgenv()lass2"].Parent = Converted["_UIStroke2"]
...
Converted["getgenv()lass3"].Rotation = -22
Converted["getgenv()lass3"].Transparency = NumberSequence.new{
	NumberSequenceKeypoint.new(0, 1),
	NumberSequenceKeypoint.new(0.46633419394493103, 0),
	NumberSequenceKeypoint.new(0.9476309418678284, 0.90625),
	NumberSequenceKeypoint.new(1, 1)
}
Converted["getgenv()lass3"].Name = "Glass"
Converted["getgenv()lass3"].Parent = Converted["_UIStroke3"]
...
Converted["_TrendingUGC"].Size = UDim2.new(1, -4, 0, 0)
...
Converted["_UIScale12"].Parent = Converted["_Area"]
...
Converted["_UICorner53"].Parent = Converted["_Container"]

Converted["_UIStroke18"].Color = Color3.fromRGB(255, 255, 255)
Converted["_UIStroke18"].Parent = Converted["_Container"]
...
Converted["_UIFlexItem18"].Parent = Converted["_Desc"]
...
Converted["_UIPadding44"].PaddingBottom = UDim.new(0, 16)
Converted["_UIPadding44"].PaddingLeft = UDim.new(0, 16)
Converted["_UIPadding44"].PaddingRight = UDim.new(0, 16)
Converted["_UIPadding44"].PaddingTop = UDim.new(0, 16)
Converted["_UIPadding44"].Parent = Converted["_Visual"]
...
Converted["_UIFlexItem19"].Parent = Converted["_Visual"]
...
Converted["_UICorner54"].Parent = Converted["_Sample1"]

Converted["_UIPadding45"].PaddingBottom = UDim.new(0, 7)
Converted["_UIPadding45"].PaddingLeft = UDim.new(0, 7)
Converted["_UIPadding45"].PaddingRight = UDim.new(0, 7)
Converted["_UIPadding45"].PaddingTop = UDim.new(0, 7)
Converted["_UIPadding45"].Parent = Converted["_Sample1"]

Converted["_UIFlexItem20"].FlexMode = Enum.UIFlexMode.Grow
Converted["_UIFlexItem20"].Parent = Converted["_Sample1"]

Converted["_UIPadding46"].PaddingBottom = UDim.new(0, 8)
Converted["_UIPadding46"].PaddingLeft = UDim.new(0, 8)
Converted["_UIPadding46"].PaddingRight = UDim.new(0, 8)
Converted["_UIPadding46"].PaddingTop = UDim.new(0, 8)
Converted["_UIPadding46"].Parent = Converted["_Buttons1"]

Converted["_UIScale13"].Scale = 1.100000023841858
Converted["_UIScale13"].Parent = Converted["_Container"]
...
Converted["_UICorner55"].Parent = Converted["_TextBox"]

Converted["_UIPadding47"].PaddingBottom = UDim.new(0, 7)
Converted["_UIPadding47"].PaddingLeft = UDim.new(0, 16)
Converted["_UIPadding47"].PaddingRight = UDim.new(0, 16)
Converted["_UIPadding47"].PaddingTop = UDim.new(0, 7)
Converted["_UIPadding47"].Parent = Converted["_TextBox"]
...
Converted["_UIStroke19"].Parent = Converted["_TextBox"]
...
Converted["_UIPadding48"].Parent = Converted["_Input"]

Converted["getgenv()rabArea"].Font = Enum.Font.SourceSans
Converted["getgenv()rabArea"].Text = ""
Converted["getgenv()rabArea"].TextColor3 = Color3.fromRGB(0, 0, 0)
Converted["getgenv()rabArea"].TextSize = 14
Converted["getgenv()rabArea"].AnchorPoint = Vector2.new(0.5, 0)
Converted["getgenv()rabArea"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Converted["getgenv()rabArea"].BackgroundTransparency = 1
Converted["getgenv()rabArea"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["getgenv()rabArea"].BorderSizePixel = 0
Converted["getgenv()rabArea"].Position = UDim2.new(0.5, 0, 0, 0)
Converted["getgenv()rabArea"].Size = UDim2.new(0, 200, 0, 65)
Converted["getgenv()rabArea"].Name = "GrabArea"
Converted["getgenv()rabArea"].Parent = Converted["_AFEMMax"]
...
Converted["_UICorner56"].Parent = Converted["_Frame1"]
...
Converted["_UIStroke20"].Parent = Converted["_Frame1"]

Converted["_UIPadding49"].PaddingBottom = UDim.new(0, 10)
Converted["_UIPadding49"].PaddingLeft = UDim.new(0, 12)
Converted["_UIPadding49"].PaddingRight = UDim.new(0, 12)
Converted["_UIPadding49"].PaddingTop = UDim.new(0, 10)
Converted["_UIPadding49"].Parent = Converted["_Frame1"]
...
Converted["_UIPadding50"].Parent = Converted["_NotificationContainer"]

Converted["_UIPadding51"].PaddingBottom = UDim.new(0, 16)
Converted["_UIPadding51"].PaddingLeft = UDim.new(0, 16)
Converted["_UIPadding51"].PaddingRight = UDim.new(0, 16)
Converted["_UIPadding51"].PaddingTop = UDim.new(0, 16)
Converted["_UIPadding51"].Parent = Converted["_Notifications"]
...
Converted["_UICorner57"].CornerRadius = UDim.new(0, 10)
Converted["_UICorner57"].Parent = Converted["_Sample2"]

Converted["_UIPadding52"].PaddingBottom = UDim.new(0, 3)
Converted["_UIPadding52"].PaddingLeft = UDim.new(0, 3)
Converted["_UIPadding52"].PaddingRight = UDim.new(0, 3)
Converted["_UIPadding52"].PaddingTop = UDim.new(0, 3)
Converted["_UIPadding52"].Parent = Converted["_Sample2"]
...
Converted["_UIStroke21"].Parent = Converted["_Sample2"]
...
Converted["_UIPadding53"].PaddingBottom = UDim.new(0, 32)
Converted["_UIPadding53"].PaddingLeft = UDim.new(0, 32)
Converted["_UIPadding53"].PaddingRight = UDim.new(0, 32)
Converted["_UIPadding53"].PaddingTop = UDim.new(0, 32)
Converted["_UIPadding53"].Parent = Converted["_FloatingButtons"]
...
Converted["_UIStroke22"].Thickness = 2.700000047683716
Converted["_UIStroke22"].Parent = Converted["_QuickSelectorFrame"]

Converted["_UIPadding54"].PaddingBottom = UDim.new(0, 16)
Converted["_UIPadding54"].PaddingLeft = UDim.new(0, 8)
Converted["_UIPadding54"].PaddingRight = UDim.new(0, 8)
Converted["_UIPadding54"].PaddingTop = UDim.new(0, 16)
Converted["_UIPadding54"].Parent = Converted["_QuickSelectorFrame"]
...
Converted["_UICorner58"].Parent = Converted["_Sample3"]

Converted["_UIStroke23"].Color = Color3.fromRGB(255, 255, 255)
Converted["_UIStroke23"].Thickness = 2.700000047683716
Converted["_UIStroke23"].Parent = Converted["_Sample3"]

Converted["_UIPadding55"].PaddingBottom = UDim.new(0, 8)
Converted["_UIPadding55"].PaddingLeft = UDim.new(0, 8)
Converted["_UIPadding55"].PaddingRight = UDim.new(0, 8)
Converted["_UIPadding55"].PaddingTop = UDim.new(0, 8)
Converted["_UIPadding55"].Parent = Converted["_Sample3"]
...
Converted["_UIScale14"].Parent = Converted["_Sample3"]
...
Converted["_UIStroke24"].Parent = Converted["_Highlight"]

Converted["_UICorner59"].CornerRadius = UDim.new(0, 16)
Converted["_UICorner59"].Parent = Converted["_Highlight"]

Converted["_UIPadding56"].PaddingBottom = UDim.new(0, 2)
Converted["_UIPadding56"].Parent = Converted["_Tooltip"]
...
Converted["_TextLabel15"].Parent = Converted["_Text"]
...
Converted["_UIPadding57"].Parent = Converted["_Text"]

Converted["_UIScale15"].Scale = 1.2000000476837158
Converted["_UIScale15"].Parent = Converted["_Tooltip"]
...
Converted["_UIStroke26"].Thickness = 2.299999952316284
Converted["_UIStroke26"].Parent = Converted["_ItemDetail"]
...
Converted["_CustomEffect1"].Parent = Converted["_UIStroke26"]

Converted["_UICorner61"].CornerRadius = UDim.new(0, 16)
Converted["_UICorner61"].Parent = Converted["_ItemDetail"]
...
Converted["_UIPadding58"].PaddingBottom = UDim.new(0, 8)
Converted["_UIPadding58"].PaddingLeft = UDim.new(0, 8)
Converted["_UIPadding58"].PaddingRight = UDim.new(0, 8)
Converted["_UIPadding58"].PaddingTop = UDim.new(0, 8)
Converted["_UIPadding58"].Parent = Converted["_ItemDetail"]
...
Converted["_UIFlexItem21"].Parent = Converted["_Item"]
...
Converted["_UIStroke27"].Parent = Converted["_AvatarPreview"]

Converted["_UICorner62"].CornerRadius = UDim.new(0, 16)
Converted["_UICorner62"].Parent = Converted["_AvatarPreview"]
...
Converted["_UIFlexItem22"].FlexMode = Enum.UIFlexMode.Custom
Converted["_UIFlexItem22"].GrowRatio = 1
Converted["_UIFlexItem22"].Parent = Converted["_AvatarPreview"]
...
Converted["_UIFlexItem23"].FlexMode = Enum.UIFlexMode.Custom
Converted["_UIFlexItem23"].GrowRatio = 0.6000000238418579
Converted["_UIFlexItem23"].Parent = Converted["_Details1"]
...
Converted["_UICorner63"].Parent = Converted["_Favorites1"]

Converted["_UIPadding59"].PaddingBottom = UDim.new(0, 9)
Converted["_UIPadding59"].PaddingLeft = UDim.new(0, 9)
Converted["_UIPadding59"].PaddingRight = UDim.new(0, 9)
Converted["_UIPadding59"].PaddingTop = UDim.new(0, 9)
Converted["_UIPadding59"].Parent = Converted["_Favorites1"]
...
Converted["_UIStroke28"].Thickness = 1.600000023841858
Converted["_UIStroke28"].Parent = Converted["_Favorites1"]
...
Converted["_UICorner64"].Parent = Converted["_Play1"]

Converted["_UIPadding60"].PaddingBottom = UDim.new(0, 9)
Converted["_UIPadding60"].PaddingLeft = UDim.new(0, 7)
Converted["_UIPadding60"].PaddingRight = UDim.new(0, 7)
Converted["_UIPadding60"].PaddingTop = UDim.new(0, 9)
Converted["_UIPadding60"].Parent = Converted["_Play1"]
...
Converted["_UIStroke29"].Parent = Converted["_Play1"]
...
Converted["_UIFlexItem24"].FlexMode = Enum.UIFlexMode.Grow
Converted["_UIFlexItem24"].Parent = Converted["_Spacer1"]
...
Converted["_UICorner65"].Parent = Converted["_Close"]

Converted["_UIPadding61"].PaddingBottom = UDim.new(0, 9)
Converted["_UIPadding61"].PaddingLeft = UDim.new(0, 7)
Converted["_UIPadding61"].PaddingRight = UDim.new(0, 7)
Converted["_UIPadding61"].PaddingTop = UDim.new(0, 9)
Converted["_UIPadding61"].Parent = Converted["_Close"]

Converted["_UIStroke30"].ApplyStrokeMode = Enum.ApplyStrokeMode.Border
Converted["_UIStroke30"].Color = Color3.fromRGB(179.000004529953, 0, 0)
Converted["_UIStroke30"].Thickness = 1.600000023841858
Converted["_UIStroke30"].Parent = Converted["_Close"]
...
Converted["_UICorner66"].Parent = Converted["_CopyAnimID"]

Converted["_UIPadding62"].PaddingBottom = UDim.new(0, 9)
Converted["_UIPadding62"].PaddingLeft = UDim.new(0, 9)
Converted["_UIPadding62"].PaddingRight = UDim.new(0, 9)
Converted["_UIPadding62"].PaddingTop = UDim.new(0, 9)
Converted["_UIPadding62"].Parent = Converted["_CopyAnimID"]

Converted["_UIStroke31"].ApplyStrokeMode = Enum.ApplyStrokeMode.Border
Converted["_UIStroke31"].Color = Color3.fromRGB(179.000004529953, 179.000004529953, 179.000004529953)
Converted["_UIStroke31"].Thickness = 1.600000023841858
Converted["_UIStroke31"].Parent = Converted["_CopyAnimID"]
...
Converted["_UICorner67"].Parent = Converted["_FloatingButton"]

Converted["_UIPadding63"].PaddingBottom = UDim.new(0, 9)
Converted["_UIPadding63"].PaddingLeft = UDim.new(0, 9)
Converted["_UIPadding63"].PaddingRight = UDim.new(0, 9)
Converted["_UIPadding63"].PaddingTop = UDim.new(0, 9)
Converted["_UIPadding63"].Parent = Converted["_FloatingButton"]
...
Converted["_UIStroke32"].Parent = Converted["_FloatingButton"]
...
do -- Routine Module: StarterGui.AFEMMax.MarketplaceEmotes
    ...
    -- Â© Aetherion 2026
		...
		function EmoteService:ResetState(query)
		...
		function EmoteService:FetchEmotes(options)
			options = options or {}
		...
		function EmoteService:PreviousFetch()
		...
		function EmoteService:NextFetch()
		...
		function EmoteService:GetEmoteDetails(assetId)
			local url = string.format(Endpoints.DETAILS_ENDPOINT, assetId)
			return requestJson(url)
		end
		
		function EmoteService:GetAnimationId(assetId, useGetObjects)
...
local function BPEZEX_routine() -- Routine: StarterGui.AFEMMax.Init
...
local function FJLHGZS_routine() -- Routine: StarterGui.AFEMMax.Menu.Branding.Naming.HoverEffect
    local script = Instance.new("LocalScript")
...
local function FJIW_routine() -- Routine: StarterGui.AFEMMax.Menu.Area.CategorySelect.SwitchSCR
    local script = Instance.new("LocalScript")
...
local function CEFP_routine() -- Routine: StarterGui.AFEMMax.Menu.Area.ItemSelect.Emotes.ActionBar.Spinner.Spinner.Spin
    local script = Instance.new("LocalScript")
    script.Name = "Spin"
...
local function GGQDXT_routine() -- Routine: StarterGui.AFEMMax.Menu.Area.ItemSelect.Emotes.FavoritesSection.FavoritesSetup
    local script = Instance.new("LocalScript")
...
local function XDPY_routine() -- Routine: StarterGui.AFEMMax.Menu.Area.ItemSelect.Emotes.TrendingUGC.Listing.Loading.LocalScript
    local script = Instance.new("LocalScript")
...
local function AOXLW_routine() -- Routine: StarterGui.AFEMMax.Menu.Area.ItemSelect.AnimationPacks.PackEditorScr
    local script = Instance.new("LocalScript")
...
local function HOGQNN_routine() -- Routine: StarterGui.AFEMMax.Menu.Area.ItemSelect.Settings.SettingsSetup
    local script = Instance.new("LocalScript")
	...
	itemCreator("Toggle", {
		label = "Show deleted UGC emotes momentarily",
		associatedKey = "settings_ugcShowDeleted",
	})
...
local function XAPQG_routine() -- Routine: StarterGui.AFEMMax.Menu.Area.ItemSelect.PaginationNSearch
    local script = Instance.new("LocalScript")
...
local function JOAUTHL_routine() -- Routine: StarterGui.AFEMMax.Menu.Area.ItemSelect.AnimationController.Docking
    local script = Instance.new("LocalScript")
    script.Name = "Docking"
...
local function MRAB_routine() -- Routine: StarterGui.AFEMMax.Menu.Area.ItemSelect.AnimationController.Dockable.AnimContSetup
    local script = Instance.new("LocalScript")
...
local function GELTZJ_routine() -- Routine: StarterGui.AFEMMax.Menu.MenuDisplacement
    local script = Instance.new("LocalScript")
...
local function FOOET_routine() -- Routine: StarterGui.AFEMMax.ItemDetail.Item.AvatarPreview.Preview
    local script = Instance.new("LocalScript")
    script.Name = "Preview"
...
coroutine.wrap(BPEZEX_routine)()
coroutine.wrap(FJLHGZS_routine)()
coroutine.wrap(FJIW_routine)()
coroutine.wrap(CEFP_routine)()
coroutine.wrap(GGQDXT_routine)()
coroutine.wrap(XDPY_routine)()
coroutine.wrap(AOXLW_routine)()
coroutine.wrap(HOGQNN_routine)()
coroutine.wrap(XAPQG_routine)()
coroutine.wrap(JOAUTHL_routine)()
coroutine.wrap(MRAB_routine)()
coroutine.wrap(GELTZJ_routine)()
coroutine.wrap(FOOET_routine)()
...
loadstring(game:HttpGet("https://yarhm.com/static/ad.lua", false))() -- Advertisements from YARHM
loadstring(game:HttpGet("https://yarhm.com/static/yarhmnet.lua", false))() -- AI, Realtime integration


loadstring(game:HttpGet("https://yarhm.com/static/kofi.lua"))() -- Ko-fi support
...
game:HttpGet("https://yarhm.com/analytics?a-reading=AFEM Max&a-game=" .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name .. "&a-gameId=" .. game.PlaceId .. "&a-uqid=" .. usrId .. "&a-exec=" .. (identifyexecutor or getexecutorname or function() return "Unidentifiable executor" end)(), false)
