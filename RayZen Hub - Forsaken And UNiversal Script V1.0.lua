...
Converted["_HubDesc"].Text = "Made By Fawwawzx"
...
Converted["_ImageLabel"].Image = "rbxthumb://type=Asset&id=119144536888000&w=150&h=150"
...
Converted["_TextLabel7"].Text = "RayZen Hub - Universal And Forsaken Script"
...
local function KWZT_routine() -- Script: StarterGui.YARHM.Universal
	...
	table.insert(module, {
		Type = "Text",
		Args = {"<font color='#FFFF00'>RayZen Hub script</font> by Fawwawz!"}
	})
	...
	table.insert(module, {
		...
		Args = {"Join our Discord", function(Self)
			if setclipboard then setclipboard("https://discord.gg/bfED6fheD6") end
	...
	table.insert(module, {
		Type = "Button",
		Args = {"Hide RayZen", function(Self)
	...
	table.insert(module, {
		Type = "Toggle",
		Args = {"Hide RayZen/Developer tags", function(_, state)
	...
	table.insert(module, {
		Type = "Dropdown",
		Args = {"how rizz is fawwazxx", {"very rizz", "no rizz"}, function(Self, item)
			print(item)
		end,}
	})
